...
1. 下载最新 release 中的 `marktab-1.0.0.zip`
2. 解压到本地文件夹
3. 打开浏览器扩展管理页面：
...
```bash
mkdir -p dist
zip -r dist/marktab-1.0.0.zip manifest.json newtab.html newtab.js styles.css popup.html popup.js icons/icon16.png icons/icon32.png icons/icon48.png icons/icon128.png
```
